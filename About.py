...
<center>
    ...
    <h1>Blocky Config Tool For ESP</h1>

    <p>Version {1}</p>

    <p>Fork the <a style="color: #004CE5;" href="https://github.com/getblocky/config-tool-esp">project on
    GitHub</a> and help improve it for all!</p>

    <p>&copy; 2018 Minh Ha. Licensed under MIT.</p>
...
'''
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, "About Blocky Config Tool For ESP")
